        ...
        <section className="login-main">
            ...
            <section className="input-field">
                <section className="input-group">
                    <span className="input-svg"><svg xmlns="http://www.w3.org/2000/svg"
                            xmlnsXlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img"
                            className="iconify iconify--ic" width="18" height="18"
                ...
                <section className="input-group">
                    <section className="input-svg">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                            aria-hidden="true" role="img" className="iconify iconify--ri" width="18" height="18"
                            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                            <path fill=""
            ...
            <NavLink className="login-link" to="/signin" >Already have an account ?</NavLink>
        </section>
